...
public class MadLibs {
    ...
    public void enterAdjective1() {
        System.out.println("I need me an adjective.");
    ...
    public void putTogetherTheStory() {
        ...
        if (num == 0) {
             story1 = "Jesse and her best fiend "+getName()+" went to Disney World today! "
                + "they saw a " + getNoun1() + " in a show at the Magic Kingdom "
                + "and ate a "+ getAdjective1() + " feast for dinner. The nest day I"
            ...
            story1 = "Amanda and her frenemy "+getName()+" went to the zoo last summer. " +
                    "They saw a huge "+ getNoun1()+ "and a tiny litt "+ getNoun2()+ ". That night"
